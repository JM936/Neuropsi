...
export const ContactFooter: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simula envio transacional de e-mail/banco
    setTimeout(() => {
      try {
        // Sucesso simulado
        setStatus('success');
    ...
    <footer id="contact" className="bg-neuro-darkBgLight border-t border-neuro-border relative pt-20 pb-8 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-20 items-stretch">
          ...
          <div className="lg:col-span-7 bg-glass/65 border border-neuro-border p-6 sm:p-10 rounded-2xl shadow-glass flex flex-col justify-between">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Botão de Envio e Feedback de Status */}
          ...
          <div className="lg:col-span-5 bg-glass-card border border-neuro-border p-6 sm:p-10 rounded-2xl flex flex-col justify-between">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a 
                      href="mailto:contato@institutoneuropsi.com.br" 
                      className="text-sm text-neuro-textSecondary hover:text-white transition-colors"
                    >
                      contato@institutoneuropsi.com.br
                    </a>
                  </div>
                </div>
            ...
            <div className="mt-8 pt-6 border-t border-white/5 text-xs text-neuro-textMuted leading-relaxed">
              O Instituto NeuroPsi é uma organização científica registrada, detentora dos registros de marcas intelectuais chanceladas pelo INPI para fomento de programas em neurociências aplicadas.
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <p className="text-xs text-neuro-textMuted text-center md:text-right">
            &copy; {new Date().getFullYear()} Instituto NeuroPsi. Todos os direitos reservados.<br />
